...
def generate_advice(
    ...
    prompt = (
        ...
        "3. SALDERING-IMPACT: dit is het verschil B1 minus A1,\n"
        "   beide in euro per jaar. Bereken:\n"
        "   saldering_impact = saldering_context.saldering_impact_eur\n"
        "   Dit is hoeveel de klant MEER betaalt als saldering\n"
        "   wegvalt. Gebruik dit getal in sectie 3, NIET A1.\n"
        ...
        "6. BESTE TARIEF MET BATTERIJ: kijk in de tariefmatrix\n"
        "   welke kolom (enkel/dag_nacht/dynamisch) de laagste\n"
        "   waarde heeft op de rij \"Geen Saldering | Met\n"
        "   Batterij\" (C1). Noem dat tarief in sectie 5.\n"
